...
const PRICING = [
  { label: "Course simple (courses, pharmacie, repas…)", price: "8 €" },
  { label: "Course express", price: "12 €" },
  {
    label: "Dépannage informatique / bricolage",
    price: "50 € / heure",
  },
  {
    label: "Mission spéciale (accompagnement, aide administrative…)",
    price: "Sur devis",
  },
];
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 md:py-20 lg:py-24 grid md:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-10 items-center">
          ...
          <div className="space-y-5">
            ...
            <p className="text-xs md:text-sm text-orange-50/85 pt-1">
              Service humain, local et bienveillant pour les habitants, seniors
              et touristes à Nice.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-600 max-w-xl mt-1">
              Une seule plateforme pour gérer les petits besoins qui prennent du
              temps : on s’adapte à ta situation, à ton logement et à ton
              rythme.
            </p>
          </div>
        </div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-sm text-slate-600 text-center max-w-2xl mx-auto mb-8">
            Tu connais ton prix avant de valider. Le tarif dépend du type de
            mission, puis on ajoute{" "}
            <span className="font-semibold">1 € par kilomètre</span> parcouru
          ...
          <div className="max-w-3xl mx-auto bg-slate-50 border border-slate-100 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-[minmax(0,2fr)_minmax(0,1fr)] text-xs md:text-sm font-semibold bg-slate-100/70 px-4 py-2">
              ...
              <div className="text-right">Tarif de base</div>
            </div>
            {PRICING.map((row, idx) => (
              <div
                key={row.label}
          ...
          <p className="text-[11px] text-slate-500 text-center mt-3">
            Exemple : course simple à 8 € + 3 km = 11 € au total.
          </p>
        </div>
      </section>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 py-10 md:py-14 flex flex-col md:flex-row items-start gap-10">
          ...
          <div className="flex-1 flex flex-col gap-3">
            {/* 🔁 ICI : maintenant ça ouvre la page opérateur, plus WhatsApp */}
            <Link
              href="/operateur"
      ...
      <footer className="bg-slate-950 text-slate-400 text-[11px]">
        <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-2">
          <p>© {new Date().getFullYear()} Il est chouette — SASU basée à Nice.</p>
